...
async function onWatchedBtnClick() {
  ...
  if (libraryQueueBtn) libraryQueueBtn.classList.remove('library__item-btn--active');
  if (libraryWatchedBtn) libraryWatchedBtn.classList.add('library__item-btn--active');
