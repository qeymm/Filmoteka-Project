...
export function addAllEventListenersModal() {
  ...
  if (queueBtn) queueBtn.addEventListener('click', onBtnQueueClick);
  if (addToWatchedButton) addToWatchedButton.addEventListener('click', onAddToWatchedBtnClick);
}
...
export function removeAllEventListenersModal() {
  ...
  if (queueBtn) queueBtn.removeEventListener('click', onBtnQueueClick);
  if (addToWatchedButton) addToWatchedButton.removeEventListener('click', onAddToWatchedBtnClick);
  startSliderAutoplay();
}
...
export async function clickOnMovieHandler(e) {
  ...
  if (backdrop) backdrop.setAttribute('id', movieId);
  ...
  if (backdrop) backdrop.classList.remove('movie-backdrop--is-hidden');
  ...
  if (addToWatchedButton && addToWatchedButton.textContent.toLowerCase() === 'add to watched') {
    addToWatchedButton.classList.remove('is-active');
  } else if (addToWatchedButton) {
    addToWatchedButton.classList.add('is-active');
  }

  if (queueBtn && queueBtn.textContent.toLowerCase() === 'add to queue') {
...
// get the movie details according to the ID
